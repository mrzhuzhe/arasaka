...
# 5. m4-1.4.19 build need under gcc gnu17 replace GL_LIST_INLINE _GL_ATTRIBUTE_NODISCARD to _GL_ATTRIBUTE_NODISCARD GL_LIST_INLINE
# 6. _GL_ATTRIBUTE_NODISCARD to GL_OSET_INLINE 
# 7. libad9361-iio-0.3 and libini-a467418 update cmake_minimum_required to 3.5
# 8. may migration to vitis -s not xsct
# reffer 
