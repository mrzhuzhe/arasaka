...
validate_bd_design
make_wrapper -files [get_files ./project_1_1.srcs/sources_1/bd/system/system.bd] -top
add_files -norecurse ./project_1_1.gen/sources_1/bd/system/hdl/system_wrapper.v
update_compile_order -fileset sources_1
